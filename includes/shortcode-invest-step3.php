...
function ypcf_shortcode_invest_return($atts, $content = '') {
	...
	case 'publish' :
	    ...
	    ypcf_create_contract($payment_id, $_GET['campaign_id'], $current_user->ID);
	    ...
	    $buffer .= '- un e-mail de confirmation d&apos;achat<br />';
	    $buffer .= '- un e-mail vous permettant de signer le pouvoir pour le contrat d&apos;investissement<br /><br />'; 
