...
?>
	<div class="atcf-update-campaign-societal_challenge">
		...
		<?php 
			wp_editor( $campaign ? html_entity_decode($campaign->societal_challenge()) : '', 'campaign_summary', apply_filters( 'atcf_submit_field_summary_editor_args', array( 
				'media_buttons' => true,
				'teeny'         => true,
				'quicktags'     => false,
...
?>
	<div class="atcf-update-campaign_value_added">
		...
		<?php 
			wp_editor( $campaign ? html_entity_decode($campaign->value_added()) : '', 'campaign_summary', apply_filters( 'atcf_submit_field_value_added_editor_args', array( 
				'media_buttons' => true,
				'teeny'         => true,
				'quicktags'     => false,
				'editor_css'    => '<style>body { background: white; }</style>',
...
?>
	<div class="atcf-update-campaign-developement_strategy">
		...
		<?php
			wp_editor( $campaign ? html_entity_decode($campaign->developement_strategy()) : '', 'campaign_summary', apply_filters( 'atcf_submit_field_developement_strategy_editor_args', array( 
				'media_buttons' => true,
				'teeny'         => true,
				'quicktags'     => false,
				'editor_css'    => '<style>body { background: white; }</style>',
...
?>
	<div class="atcf-update-campaign_economic_model">
		...
		<?php 
			wp_editor( $campaign ? html_entity_decode($campaign->economic_model()) : '', 'campaign_summary', apply_filters( 'atcf_submit_field_economic_model_editor_args', array( 
				'media_buttons' => true,
				'teeny'         => true,
				'quicktags'     => false,
				'editor_css'    => '<style>body { background: white; }</style>',
...
?>
	<div class="atcf-update-campaign_measuring_impact">
		...
		<?php 
			wp_editor( $campaign ? html_entity_decode($campaign->measuring_impact()) : '', 'campaign_summary', apply_filters( 'atcf_submit_field_measuring_impact_editor_args', array( 
				'media_buttons' => true,
				'teeny'         => true,
				'quicktags'     => false,
				'editor_css'    => '<style>body { background: white; }</style>',
...
?>
	<div class="atcf-update-campaign-implementation">
		...
		<?php 
			wp_editor( $campaign ? html_entity_decode($campaign->implementation()) : '', 'campaign_summary', apply_filters( 'atcf_submit_field_implementation_editor_args', array( 
				'media_buttons' => true,
				'teeny'         => true,
				'quicktags'     => false,
				'editor_css'    => '<style>body { background: white; }</style>',
