 ...
 */
 function ypcf_shortcode_edit_news() {
	...
	<div style="padding-top: 80px;">
		<a href="<?php echo WDG_Redirect_Engine::override_get_page_url( 'tableau-de-bord' ); ?>?campaign_id=<?php echo $_GET['campaign_id']; ?>#news">&lt;&lt; Retour au tableau de bord</a>
	</div>
...
function ypcf_shortcode_edit_news_field_postcontent($post) {
	...
	<?php
	    wp_editor($post->post_content, 'postcontent', apply_filters('ypcf_submit_field_postcontent_editor_args', array(
			'media_buttons' => true,
			'quicktags'     => false,
