...
class WDGEmails {
	...
	public static function auto_notifications($campaign_id, $mail_type, $input_testimony_in, $input_image_url, $input_image_description, $input_send_option, $user_already_sent_to = array()) {
		...
		if ( strpos( strtolower( $input_send_option ), 'test' ) !== FALSE ) {
			...
			switch ( $mail_type ) {
				case 'preinvestment':
					NotificationsAPI::confirm_vote_invest_intention( $WDGUserOrOrganization, $intention_amount, $campaign, $input_testimony, $input_image_url, $input_image_description, $project_api_id );
					NotificationsAPI::confirm_vote_invest_no_intention( $WDGUserOrOrganization, $campaign, $input_testimony, $input_image_url, $input_image_description, $project_api_id );
					break;
				case 'prelaunch':
					NotificationsAPI::confirm_prelaunch_invest_intention( $WDGUserOrOrganization, $intention_amount, $campaign, $input_testimony, $input_image_url, $input_image_description, $project_api_id );
					NotificationsAPI::confirm_prelaunch_invest_no_intention( $WDGUserOrOrganization, $campaign, $input_testimony, $input_image_url, $input_image_description, $project_api_id );
					NotificationsAPI::confirm_prelaunch_invest_follow( $WDGUserOrOrganization, $campaign, $input_testimony, $input_image_url, $input_image_description, $project_api_id );
					break;
				case 'investment-30':
					NotificationsAPI::confirm_investment_invest30_intention( $WDGUserOrOrganization, $intention_amount, $campaign, $project_percent, $input_testimony, $input_image_url, $input_image_description, $project_api_id );
					NotificationsAPI::confirm_investment_invest30_no_intention( $WDGUserOrOrganization, $campaign, $input_testimony, $input_image_url, $input_image_description, $project_api_id );
					NotificationsAPI::confirm_investment_invest30_follow( $WDGUserOrOrganization, $campaign, $input_testimony, $input_image_url, $input_image_description, $project_api_id );
					break;
				case 'investment-100':
					NotificationsAPI::confirm_investment_invest100_invested( $WDGUserOrOrganization, $campaign, $project_api_id );
					NotificationsAPI::confirm_investment_invest100_investment_pending( $WDGUserOrOrganization, $campaign, $input_testimony, $input_image_url, $input_image_description, $project_api_id );
					NotificationsAPI::confirm_investment_invest100_intention( $WDGUserOrOrganization, $intention_amount, $campaign, $input_testimony, $input_image_url, $input_image_description, $project_api_id );
					NotificationsAPI::confirm_investment_invest100_no_intention( $WDGUserOrOrganization, $campaign, $input_testimony, $input_image_url, $input_image_description, $project_api_id );
					NotificationsAPI::confirm_investment_invest100_follow( $WDGUserOrOrganization, $campaign, $input_testimony, $input_image_url, $input_image_description, $project_api_id );
					break;
			...
			switch ( $mail_type ) {
				...
				case 'investment-30':
					if ( $intention_amount == 'follow' ) {
						...
						NotificationsAPI::confirm_investment_invest30_intention( $WDGUserOrOrganization, $intention_amount, $campaign, $input_testimony, $input_image_url, $input_image_description, $project_api_id );
					} else {
						NotificationsAPI::confirm_investment_invest30_no_intention( $WDGUserOrOrganization, $campaign, $input_testimony, $input_image_url, $input_image_description, $project_api_id );
					}
					break;
		...
		if ( strpos( strtolower( $input_send_option ), 'test' ) !== FALSE ) {
			...
			switch ( $mail_type ) {
				case 'vote-end-pending-campaign':
					NotificationsAPI::vote_end_pending_campaign( $WDGUserOrOrganization, $campaign, $project_api_id );
					break;
				case 'vote-end-canceled-campaign':
					...
					NotificationsAPI::vote_end_canceled_campaign_refund( $WDGUserOrOrganization, $campaign, $project_api_id );
					break;
			}
