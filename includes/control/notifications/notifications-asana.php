...
class NotificationsAsana {
	...
	public static function investment_pending_wire($payment_id) {
		...
		$content = "- Mettre cette tâche dans le projet du client et l'enlever du projet Support client.<br>";
		$content .= "- Ajouter une échéance 3 jours plus tard pour vérifier si le virement est bien arrivé (en regardant sur Slack investisseurs-notifications par exemple).<br><br><br>";
		...
		$content .= "- téléphone : " . get_user_meta($user_data->ID, 'user_mobile_phone', true);
