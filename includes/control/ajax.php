		...
		if ($update) {
			...
			$return_values = array(
				...
				"organization" => array(
					...
					"employees_count" 		=> $organization_selected->get_employees_count(),
		...
		if ( $return === FALSE ) {//user non connecté
			...
			$return_values = array(
				...
				"organization" => array(
					...
					"employees_count"		=> $org_object->get_employees_count(),
	...
	public static function save_edit_organization(){
		...
		$return_values = array(
			...
			'organization'	=> array(
				...
				'employees_count'		=> $WDGOrganization->get_employees_count(),
